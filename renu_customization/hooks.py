...
fixtures = [
    ...
    {"dt": "User", "filters": [["name", "not in", ["Administrator"]]]},
    {"dt": "Role"},
    {"dt": "Role Profile"},
    {"dt": "User Permission"},
    {"dt": "Custom Role"},
    ...
    {"dt": "Tax Withholding Account"},

    # ---------- Tree Doctypes (Ordered) ----------
    {"dt": "Account", "filters": [["is_group", "=", 1]]},  # parents first
    {"dt": "Account", "filters": [["is_group", "=", 0]]},  # then leaf nodes
    {"dt": "Cost Center", "filters": [["is_group", "=", 1]]},
    {"dt": "Cost Center", "filters": [["is_group", "=", 0]]},
    {"dt": "Warehouse", "filters": [["is_group", "=", 1]]},
    {"dt": "Warehouse", "filters": [["is_group", "=", 0]]},
    {"dt": "Item Group", "filters": [["is_group", "=", 1]]},
    {"dt": "Item Group", "filters": [["is_group", "=", 0]]},
    {"dt": "UOM"},
    {"dt": "Territory"},
    ...
    # ---------- POS & Local Compliance ----------
    {"dt": "POS Profile"},
    {"dt": "POS Settings"},
    {"dt": "Pricing Rule"},
    {"dt": "GST Invoice Management System"},
