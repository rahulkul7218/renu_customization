frappe.query_reports["Pending Payment Report-1"] = {
	...
	onload: function (report) {
		...
		report.page.add_inner_button(__('Export with Formatting'), function () {
			...
			let d = new frappe.ui.Dialog({
				title: __("Export Pending Payment Report-1"),
				fields: [
					{
				...
				primary_action: function (values) {
					...
					frappe.call({
						method: "renu_customization.renu_customization.report.pending_payment_report_1.pending_payment_report_1.download_xlsx",
						args: {
							filters: filters
						},
						callback: function (r) {
