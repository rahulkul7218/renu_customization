...
#         if planned_qty <= 0:
#             continue  # skip logging "Planned Purchase Qty is 0"
...
#         # ❌ Check for Rate = 0
#         zero_rate_items = [i["item_code"] for i in po_items if not frappe.db.get_value("Item Price", {"item_code": i["item_code"]}, "price_list_rate") or frappe.db.get_value("Item Price", {"item_code": i["item_code"]}, "price_list_rate") == 0]
#         if zero_rate_items:
#             for zi in zero_rate_items:
#                 log_entries.append({
#                     "item": zi,
#                     "run_date": nowdate(),
#                     "status": "Failed",
#                     "reason": "Rate not set in Price List for this item"
#                 })
#             continue  # skip PO creation
...
#     #         "run_date": nowdate(),
#     #         "status": "Success",
#     #         "reason": f"POs Created: {', '.join(created_pos)}"
#     #     }).insert(ignore_permissions=True)

#     # Log failures (excluding planned qty 0)
